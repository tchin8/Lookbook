...
import { faNewspaper, faShareSquare, faThumbsUp, faComment} from '@fortawesome/free-regular-svg-icons';
...
library.add(fab, faExclamationCircle, faBell, faHome, faSortDown, faTv, faPlay, 
  ...
  faEllipsisH, faTimes, faUserTag, faMapMarkerAlt, faUserFriends, faSlidersH, faList, faThLarge, faThumbsUp, faComment);
